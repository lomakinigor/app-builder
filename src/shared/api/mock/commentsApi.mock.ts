  ...
  m.set(storeKey('proj-demo', 'spec', 'proj-demo'), [
    {
      ...
      body: 'Скоуп MVP выглядит разумно. Начнём с обязательных функций.',
      authorLabel: 'owner',
  ...
  m.set(storeKey('proj-demo', 'architecture', 'proj-demo'), [
    {
      ...
      artifactId: 'proj-demo',
      body: 'Выбор технологического стека выглядит надёжно. React + Zustand хорошо масштабируется для этого кейса.',
      authorLabel: 'editor',
  ...
  m.set(storeKey('proj-demo', 'prompt_iteration', 'prompt-demo-1'), [
    {
      ...
      body: 'Хороший прогресс по T-001. Тесты проходят.',
      authorLabel: 'owner',
