...
/**
 * Application spec with canonical feature names matching T-102 service fixtures.
 * These feature names are the ones the service generates for projectType=application.
 */
...
/**
 * Website spec with canonical feature names matching T-102 service fixtures.
 * These feature names are the ones the service generates for projectType=website.
 */
